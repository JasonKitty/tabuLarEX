...
class NougatModelPLModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx, dataset_idx=0):
        ...
        # scores: {'val/teds': (1.9, 2)}
        # validation_step_outputs: [scores1, socres2]
        return scores
    ...
    def on_validation_epoch_end(self):
        if (
            ...
            cumulative_scores = {}
            for scores in self.validation_step_outputs:
    ...
    def on_save_checkpoint(self, checkpoint):
        ...
        self.model.save_pretrained(save_path_last, safe_serialization=False)
        self.model.decoder.tokenizer.save_pretrained(save_path_last, safe_serialization=False)
